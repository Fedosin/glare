            ...
            u'sample_artifact': {
                ...
                u'properties': {
                    ...
                    u'int2': {
                        u'type': [u'integer',
                                  u'null']},
                    u'license': {u'type': [u'string',
                                           u'null']},
                    u'license_url': {u'type': [u'string',
                                               u'null']},
                    u'list_of_int': {u'items': {
                        u'type': u'string'},
                        u'type': [
                            u'array',
                            u'null']},
                    u'list_of_str': {u'items': {
                        u'type': u'string'},
                        u'type': [
                            u'array',
                            u'null']},
                    ...
                    u'name': {
                        u'type': u'string'},
                    u'owner': {u'readOnly': True,
                               u'type': u'string'},
                    u'provided_by': {
                        u'additionalProperties': {u'type': u'string'},
                        u'type': [u'object',
                                  u'null']},
                    u'release': {u'items': {u'type': u'string'},
                                 u'type': [u'array',
                                           u'null']},
                    u'status': {
                        u'enum': [u'queued',
                ...
                u'required': [u'name'],
                u'title':
                    u'Artifact type "sample_artifact" of version 1.0',
                u'type': u'object'}}

        # Get list schemas of artifacts
        result = self.get(url='/schemas')
        self.assertEqual({'schemas': schema_sample_artifact}, result)
